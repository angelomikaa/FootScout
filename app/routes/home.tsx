      ...
      <div className="mb-8">
        <div className="bg-white dark:bg-fm-card rounded-lg border border-gray-200 dark:border-fm-border overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200 dark:border-fm-border flex items-center justify-between">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-fm-text">Ações Rápidas</h2>
          </div>
          <div className="p-6">
            <Link
              to="/scout/report"
              className="flex items-center justify-between w-full p-5 rounded-xl bg-fm-accent hover:bg-fm-accent-hover text-white transition-colors group"
            >
            ...
            {draftReports.length > 0 && (
              <Link
                to="/scout/report"
                className="mt-3 flex items-center justify-between w-full p-4 rounded-xl border border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-900/10 hover:border-amber-300 dark:hover:border-amber-700 transition-colors group"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-medium text-amber-800 dark:text-amber-300">Continuar Rascunho</h4>
